...
class MNet(BasicNet):
    def __init__(self, n_channels, n_classes, kn=(8, 16, 24, 32, 40), ds=False, FMU='sub'):
        """
        Args:
            n_channels: channels of input
        ...
        self.down11 = Down(n_channels, kn[0], ('/', 'both'), downsample=False)
        ...
        self.outputs = nn.ModuleList(
            [nn.Conv3d(c, n_classes, kernel_size=(1, 1, 1), stride=1, padding=0, bias=False)
    ...
    def forward(self, x):
        ...
        return self.softmax(self.outputs[0](up14[0] + up14[1]))
